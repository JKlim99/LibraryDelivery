...
public class DelivererDeliveryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        else if(deliveryModel.getStatus().equals("Delivering")){
        ...
        setContentView(R.layout.activity_deliverer_delivery_details);
    }
