...
public class DelivererDeliveryAdapter extends ArrayAdapter<DeliveryModel> {

    // constructor for our list view adapter.
    public DelivererDeliveryAdapter(@NonNull Context context, ArrayList<DeliveryModel> DeliveryModelArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        listitemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, DelivererDeliveryDetails.class);
