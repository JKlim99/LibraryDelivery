...
public class AdminBookLoanAdapter extends ArrayAdapter<BookLoanModel> {
    private View listitemView;
    private static final String TAG = "";

    // constructor for our list view adapter.
    public AdminBookLoanAdapter(@NonNull Context context, ArrayList<BookLoanModel> BookLoanModelArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        listitemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, AdminBookLoanDetails.class);
